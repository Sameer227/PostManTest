...
let token = "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";
let user = "sameer227"
//list all repo's
...
axios.put(`https://api.github.com/repos/${user}/PostManTest/contents/folder/server3.js`, {
    owner: user,
    repo: 'PostManTest',
    path: 'folder/server3.js',
    message: "test1",
    committer: {
        name: "sameer Soni",
